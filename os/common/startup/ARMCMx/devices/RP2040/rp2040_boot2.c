 ...
 *
 * Adapted from QMK Firmware for ChibiOS.
 */

#include <stdint.h>

#define BOOT2_SECTION __attribute__((used, section(".boot2")))
...
/*
 * Adesto AT25SF128A flash
 */
const uint8_t BOOT2_SECTION boot2_rom[256] = {
...
/*
 * Generic flash using 03h read command (no QSPI)
 * Works with most flash chips but slower than QSPI modes.
 */
const uint8_t BOOT2_SECTION boot2_rom[256] = {
...
/*
 * Default: Winbond W25Q080 flash (used on Raspberry Pi Pico)
 * This is the standard boot2 for most RP2040 boards.
 */
const uint8_t BOOT2_SECTION boot2_rom[256] = {
